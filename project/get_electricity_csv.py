...
def culminate_data(df):
    ...
    df['Erneuerbare Energie [MWh]'] = df[
        ['Biomasse [MWh] Berechnete Auflösungen', 'Wasserkraft [MWh] Berechnete Auflösungen',
         'Wind Offshore [MWh] Berechnete Auflösungen', 'Wind Onshore [MWh] Berechnete Auflösungen',
         'Photovoltaik [MWh] Berechnete Auflösungen', 'Sonstige Erneuerbare [MWh] Berechnete Auflösungen']].sum(axis=1)
    df['Konventionelle Energie [MWh]'] = df[
        ['Kernenergie [MWh] Berechnete Auflösungen', 'Braunkohle [MWh] Berechnete Auflösungen',
         'Steinkohle [MWh] Berechnete Auflösungen', 'Erdgas [MWh] Berechnete Auflösungen',
         'Pumpspeicher [MWh] Berechnete Auflösungen', 'Sonstige Konventionelle [MWh] Berechnete Auflösungen']].sum(
        axis=1)
...
if __name__ == "__main__":
    ...
    requestSmardData(modulIDs=modules, timestamp_from_in_milliseconds=1420066800000,
                     timestamp_to_in_milliseconds=1715724000000)
